                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="{{ route('admin.advert-list') }}" class="menu-link active">
                                                    <span
                                                    ...
                                                    <span class="d-flex flex-column">
                                                        <span class="fs-6 fw-bold text-gray-800">Advert</span>
                                                        <span class="fs-7 fw-semibold text-muted">Advert details</span>
                                                    </span>
                                                </a>
                                                <!--end:Menu link-->
                                            </div>
        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                    ...
                    {{-- <img src="{{ URL::to('admin/media/avatars/300-3.jpg') }}" class="rounded-3" alt="user" /> --}}
                    ...
                    <div class="menu-item px-5">
                        <form action="{{ route('admin.logout') }}" method="POST" id="logout_form">
                            ...
                            <a href="javascript:void(0);" class="menu-link px-5"
                                ...
                                Sign Out <i class="entypo-logout right"></i> </a>
                        </form>
                    </div>
                    <!--end::Menu item-->
                </div>
